    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <button onClick={() => { navigate("/home/videos") }}>
                    <List>
                        <ListItem disablePadding sx={{ display: 'block' }}>
                            <ListItemButton
                                sx={{
                            ...
                            >
                                ...
                                <ListItemText primary={"Videos"} sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>
